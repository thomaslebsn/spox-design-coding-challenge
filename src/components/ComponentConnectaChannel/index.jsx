                        ...
                        <div key={index} className="bg-white rounded-3 mb-4">
                          <CustomToggle eventKey={item.id}>
                            <div className="d-flex align-items-center">
                              <img className="img-avatar" src={item.image} alt="" />
                              <span className="ms-2 fs-4 text-blue-0">{item.name}</span>
                            </div>
                                ...
                                <div className={`list_main `}>
                                  {
                                    item.list.map((itemList, keyList) => {
                                      return (
                                        <div key={keyList} className={`item_accordion ${styles.item_accordion} p-3 border-bottom-1 d-flex align-items-center`}>
                                          <div className="col-4">
                                            <div className="d-flex align-items-center">
                                              <img className="img-avatar" src={itemList.image} alt="" />
                                              <span className="ms-2">{itemList.name}</span>
                                            </div>
                                          </div>
                                          <div className="col-2">{itemList.type}</div>
                                          <div className="col-6 text-end">
                                            <div className="d-flex align-items-center justify-content-end">
                                              <a href="/social-media" className="btn -btn-light">
                                                <i>
                                                  <FontAwesomeIcon icon={faSync} />
                                                </i>
                                                <span className="ms-2">Reconnect</span>
                                              </a>
                                              <a href={void(0)} className="btn -btn-light">
                                                <i>
