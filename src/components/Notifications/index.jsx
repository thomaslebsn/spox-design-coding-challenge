...
const data = [
  {
    ...
    text:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cur aitur id ipsum ut arcu commodo faucibus.",
  },
  {
    key: 2,
    icon: "/assets/images/avatar.png",
      ...
      <ul className="ps-0 list-unstyled mb-0">
        {data.map((value, index) => {
          return (
            <li
              key={index}
              className="pt-3 pb-3 border-bottom-1 border-gray item_notification"
            >
        ...
        <Dropdown>
          ...
          <Dropdown.Menu className="top-100 shadow border-0 p-3">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <p className="text_heading_bell fs-12 mb-0 black opacity-50 text-white">
