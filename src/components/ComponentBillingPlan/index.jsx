...
class ComponentBillingPlan extends React.Component {
  ...
  constructor(props) {
    ...
    this.billingPlanViewModel = this.props.billingPlanViewModel;
  }

  componentDidMount() {
    //append paddle js lib
  ...
  handleSelectSubscriptionPlan = (planName) => {
    ...
    this.billingPlanViewModel.getPayLinkModel(planName);

    let payLink = this.billingPlanViewModel.payLink;
    console.log('==================== 2222', payLink)
    ...
    //   passthrough: "{\"member_id\": 98765, \"plan_name\": \"Acme Corp\", \"plan_id\": \"Acme Corp\"}"
    // });
  }
    ...
    return (
      <div className="container-fluid">
        <div className="row" role="rowgroup">
          <div role="row" className="d-none col_thumb cursor-pointer undefined col-6 mb-6 bg-white shadow-sm h-100 ">
            <div className="row">
          ...
          <div className="wrapper_btn_group plan" role="group">
            <div className="main_btn_group">
              ...
              <div id="item_btn_group_annual" className="item_btn_group">
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio2">Annual</label>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="d-table w-100 content_table">
            <div className="d-table-row table_row_header">
              ...
              <div className="d-table-cell p-3 ">
                ...
                <div className="price">
                  <div className="monthly"><span className="number">$0</span> <span>per month</span></div>
                  <div className="yearly"><span className="number">$0</span> <span>per year</span></div>
                </div>

                <div>
                  <a href="#" className="btn btn-success getstarts"
                     data-itemname="Free"
                     onClick={(e) => {
                       this.handleSelectSubscriptionPlan("free");
                     }}
                     data-toggle="modal" data-target=".talktosales"> Get Started
              ...
              <div className="d-table-cell p-3 ">
                ...
                <div className="price">
                  <div className="monthly"><span className="number">$29</span> <span>per month</span></div>
                  <div className="yearly"><span className="number">$320</span> <span>per year</span></div>
                </div>
                <div>
                  <a href="#" className="btn btn-success getstarts"
                     onClick={(e) => {
                       this.handleSelectSubscriptionPlan("small");
                     }}
                     data-toggle="modal" data-target=".talktosales"> Get Started
                    <svg aria-hidden="true"
                         focusable="false"
              ...
              <div className="d-table-cell p-3 ">
                ...
                <div className="price">
                  <div className="monthly"><span className="number">$69</span> <span>per month</span></div>
                  <div className="yearly"><span className="number">$800</span> <span>per year</span></div>
                </div>
                <div>
                  <a href="#" className="btn btn-success getstarts"
                     onClick={(e) => {
                       this.handleSelectSubscriptionPlan("medium");
                     }}
                     data-toggle="modal" data-target=".talktosales"> Get Started
                    <svg aria-hidden="true"
                         focusable="false"
              ...
              <div className="d-table-cell p-3 ">
                ...
                <div className="price">
                  <div className="monthly"><span className="number">$99</span> <span>per month</span></div>
                  <div className="yearly"><span className="number">$1,160</span> <span>per year</span></div>
                </div>
                <div>
                  <a href="#" className="btn btn-success getstarts"
                     onClick={(e) => {
                       this.handleSelectSubscriptionPlan("pro");
                     }}
                     data-toggle="modal" data-target=".talktosales"> Get Started
                    <svg aria-hidden="true"
                         focusable="false"
              ...
              <div className="d-table-cell p-3 ">
                ...
                <div className="price">
                  <div className="monthly"><span className="number">$199</span> <span>per month</span></div>
                  <div className="yearly"><span className="number">$2,360</span> <span>per year</span></div>
                </div>
                <div><a href="#" className="btn btn-success getstarts"
                        onClick={(e) => {
                          this.handleSelectSubscriptionPlan("enterprise");
                        }}
                        data-toggle="modal" data-target=".talktosales"> Get Started
                  <svg aria-hidden="true"
                       focusable="false"
            ...
            <div className="d-table-row">
              ...
              <div className="d-table-cell value"><span className="iconCheck">
            ...
            <div className="d-table-row">
              ...
              <div className="d-table-cell value"><span className=""></span></div>
              <div className="d-table-cell value"><span className=""></span></div>
              <div className="d-table-cell value"><span className=""></span></div>
              <div className="d-table-cell value"><span className=""></span></div>
              <div className="d-table-cell value"><span className=""></span></div>
