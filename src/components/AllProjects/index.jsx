          ...
          <div className="p-3">
            <div className="d-flex position-relative mb-3">
              <FormControl
                ...
                value={value}
              />
              <i className="position-absolute right-0 top-0 bottom-0 mr-3 d-flex align-items-center green">
              ...
              <Dropdown.Menu as={this.CustomMenu}>
                  {
                    data.map((value, index) => {
                      return (
                        <Dropdown.Item key={index} eventKey={value.key} className="d-flex align-items-center p-2">
