...
class LinkedInSocial extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      getUrlImage: this.field.dataContentDescriptionSocial.list_channels.social.linkedin.assets.damAssets,
      description: this.field.dataContentDescriptionSocial.list_channels.social.linkedin.description
    }
  ...
  handleDamAssets(data) {
    if(data[0].extension != "mp4") {
      ...
      this.field.dataContentDescriptionSocial.list_channels.social.linkedin.assets.damAssets = data;
