...
class MediumSocial extends Component {
  constructor(props) {
    ...
    this.state = {
      getUrlImage: this.field.dataContentDescriptionSocial.list_channels.social.medium.assets.damAssets,
      description: this.field.dataContentDescriptionSocial.list_channels.social.medium.description
    }
  ...
  handleDamAssets(data) {
    if(data[0].extension != "mp4") {
      ...
      this.field.dataContentDescriptionSocial.list_channels.social.medium.assets.damAssets = data;
