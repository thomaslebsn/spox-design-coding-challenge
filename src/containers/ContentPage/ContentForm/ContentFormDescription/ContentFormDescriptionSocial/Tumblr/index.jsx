...
class TumblrSocial extends Component {
  constructor(props) {
    ...
    this.state = {
      getUrlImage: this.field.dataContentDescriptionSocial.list_channels.social.tumblr.assets.damAssets,
      description: this.field.dataContentDescriptionSocial.list_channels.social.tumblr.description
    }
  ...
  handleDamAssets(data) {
    if(data[0].extension != "mp4") {
      ...
      this.field.dataContentDescriptionSocial.list_channels.social.tumblr.assets.damAssets = data;
