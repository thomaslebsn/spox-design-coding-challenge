...
class MailchimpSocial extends Component {
  constructor(props) {
    super(props);
  ...
  handleCanva(exportUrl, designId) {
    this.field.dataContentDescriptionSocial.list_channels.mail.mailchimp.assets.canvaAssets = {
      exportUrl: exportUrl,
      designId: designId,
    };
...
export default MailchimpSocial;
