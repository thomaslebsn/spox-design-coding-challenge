...
class WordpressSocial extends Component {
  constructor(props) {
    ...
    this.state = {
      getUrlImage: this.field.dataContentDescriptionSocial.list_channels.cms.wordpress.assets.damAssets,
      description: this.field.dataContentDescriptionSocial.list_channels.cms.wordpress.description
    }
  ...
  handleChange(event) {
    ...
    this.field.dataContentDescriptionSocial.list_channels.cms.wordpress.description = event.target.value;
    this.props.changed(event.target.value);
  }

  handleCanva(exportUrl, designId) {
    this.field.dataContentDescriptionSocial.list_channels.cms.wordpress.assets.canvaAssets = {
      exportUrl: exportUrl,
      designId: designId,
    };
  ...
  render() {
    ...
    return (
      <>
        <Form.Control
          as="textarea"
          //defaultValue={this.field.dataContentDescriptionSocial.list_channels.cms.wordpress.description}
          value={description}
