...
//import {ESI_PERSONA_TEMPLATE_FIELD_KEY} from "easii-io-web-service-library";
...
class PersonaTemplateModel {
  constructor(data) {
    ...
    this.image =
      data[ESI_PERSONA_TEMPLATE_FIELD_KEY.IMAGE] ?? "/assets/images/annotation.png";
  ...
  static convertSubmittedDataToAPIService(personaData) {
    const result = personaData
      ? {
          ...
          [ESI_PERSONA_TEMPLATE_FIELD_KEY.NAME]:
            personaData[PERSONA_TEMPLATE_FIELD_KEY.NAME] ?? "",
