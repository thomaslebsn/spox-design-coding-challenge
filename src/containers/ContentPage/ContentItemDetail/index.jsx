            ...
            <table className={`w-100 mb-4 `}>
              <thead>
                <tr className="bg-blue">
                  <th colspan="1" role="columnheader" className="fw-normal px-2 py-3 flex-1">Title</th>
                  <th colspan="1" role="columnheader" className="fw-normal px-2 py-3 flex-1">Channels</th>
                  <th colspan="1" role="columnheader" className="fw-normal px-2 py-3 flex-1">Status</th>
              ...
              <tbody >
                <tr className="border-bottom-1 cursor-pointer" >
                  ...
                  <td className="fw-normal px-2 py-3">
                    <div className="d-flex">
                      {
                        getNameChannel && getNameChannel.map((value, key) => {
                          return (
                ...
                {
                  subDataContentItemDetail && subDataContentItemDetail.map((value, key) => {
                    return (
                          ...
                          <div className="d-flex">
                            <div key={key} className="position-relative me-2">
                              <Image
                                ...
                                className="position-absolute bottom-0 end-0"
                              />
                              <Image src={`/assets/images/${value.channel}.png`} rounded width="40" />
                            </div>
                          </div>
                        </td>
