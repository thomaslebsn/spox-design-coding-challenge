...
class PersonaModel {
  constructor(data) {
    ...
    this.image =
      data[ESI_PERSONA_FIELD_KEY.IMAGE] ?? "/assets/images/annotation.png";
    ...
    const result = personaData
      ? {
          ...
          [ESI_PERSONA_FIELD_KEY.LOCATION]:
            personaData[PERSONA_FIELD_KEY.LOCATION] ?? "",
          [ESI_PERSONA_FIELD_KEY.TOOLS]:
            personaData[PERSONA_FIELD_KEY.TOOLS] ?? "",
          [ESI_PERSONA_FIELD_KEY.JOB_TITLE]:
            personaData[PERSONA_FIELD_KEY.JOB_TITLE] ?? "",
          [ESI_PERSONA_FIELD_KEY.WEBSITE]:
            personaData[PERSONA_FIELD_KEY.WEBSITE] ?? "",
          [ESI_PERSONA_FIELD_KEY.SECTOR]:
            personaData[PERSONA_FIELD_KEY.SECTOR] ?? "",
          [ESI_PERSONA_FIELD_KEY.VENDOR_RESEARCH]:
            personaData[PERSONA_FIELD_KEY.VENDOR_RESEARCH] ?? "",
          [ESI_PERSONA_FIELD_KEY.GOALS]:
            personaData[PERSONA_FIELD_KEY.GOALS] ?? "",
          [ESI_PERSONA_FIELD_KEY.MARITAL_STATUS]:
            personaData[PERSONA_FIELD_KEY.MARITAL_STATUS] ?? "",
          [ESI_PERSONA_FIELD_KEY.CHALLENGES]:
            personaData[PERSONA_FIELD_KEY.CHALLENGES] ?? "",
          [ESI_PERSONA_FIELD_KEY.PAINT_POINT]:
            personaData[PERSONA_FIELD_KEY.PAINT_POINT] ?? "",
