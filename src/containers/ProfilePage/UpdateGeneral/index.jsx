...
const UpdateGeneral = observer(class UpdateGeneral extends Component {
  ...
  handleInputChange(type, value) {
    if (type === 'birthday') {
      this.formPropsData[type] = value.getFullYear() + '-' +
        (parseInt(value.getMonth()) + 1) + '-' + value.getDate() + ' 00:00:00';
    } else {
            ...
            <div className='row'>
              <div className='col-6'>
                ...
                <div className='border-da-1 mb-3'>
                  <div
                    className={`position-relative cursor-pointer wr_upload_images ${getUrlImage.length >
                    0 ? 'active_img' : ''}`}>
                    <div
                      className='d-flex align-items-center p-3 wr_icon_upload justify-content-center'>
              ...
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.FULLNAME], event.target.value)}
                />
              </div>
              <div className='col-6'>
            ...
            <div className='d-flex align-items-center row'>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.PHONE], event.target.value)}
                />
              </div>
              <div className='col-6'>
                ...
                <div className='form-control mb-3'>
                  <CustomizedDatePicker
                    handleOnChange={(date) => this.handleInputChange(
                      UPDATE_GENERAL_FIELD_KEY.BIRTHDAY, date)}
                    defaultDate={memberInfo.birthday
                      ? memberInfo.birthday.substr(0, 10)
                      : null} />
                </div>
              </div>
            </div>
            <div className='d-flex align-items-center row'>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.ADDRESS], event.target.value)}
                />
              </div>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.ADDRESS_2], event.target.value)}
                />
              </div>
            </div>
            <div className='d-flex align-items-center row'>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.CITY], event.target.value)}
                />
              </div>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.STATE], event.target.value)}
                />
              </div>
            </div>
            <div className='d-flex align-items-center row'>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.COUNTRY], event.target.value)}
                />
              </div>
              <div className='col-6'>
                ...
                <input
                  ...
                  onChange={event => this.handleInputChange(
                    [UPDATE_GENERAL_FIELD_KEY.ZIPCODE], event.target.value)}
                />
              </div>
            </div>
            <div className='d-flex align-items-center row'>
